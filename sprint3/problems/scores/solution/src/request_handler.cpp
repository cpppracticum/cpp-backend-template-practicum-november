...
namespace http_handler {
    ...
    namespace {
        ...
        // Новая функция для сериализации игрока с рюкзаком и счетом
        json::object SerializePlayer(const model::Player& player, const model::Dog& dog) {
            ...
            // Рюкзак - ТЗ требует массив объектов с id и type
            json::array bag_json;
        ...
        // Новая функция для сериализации потерянных предметов
